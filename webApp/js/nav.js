...
logoImage.setAttribute('src', '/MicroBlaug/webApp/images/micro-blue-logo-2000-500.png');
...
link1.setAttribute('href', '/MicroBlaug/home.html');
...
link5.setAttribute('href', '/MicroBlaug/index.html');
...
if (sessonId === 'loggedIn') {
    ...
    link2.setAttribute('href', '/MicroBlaug/post/dashboard.html');
    navLinksDiv.appendChild(link2);
    link2.innerHTML = 'Dashboard';

    const link3 = document.createElement('a');
    link3.setAttribute('href', '/MicroBlaug/profile.html');
    navLinksDiv.appendChild(link3);
    link3.innerHTML = 'Profile';

    const link4 = document.createElement('a');
    link4.setAttribute('href', '/MicroBlaug/index.html');
